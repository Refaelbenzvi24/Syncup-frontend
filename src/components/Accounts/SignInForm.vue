      ...
      <v-card>
        <v-container>
          ...
          <v-card-text class="text">
            ...
            <br />already used with google sign up method <br />if so please try
            sign in using google. <br />If you want you can add password option
            later. <br />We can also redirect you after sign in by clicking
            <a href>here...</a>
            <br />If you encountering this error again <br />please let us know
            at <a href="SyncUp@support.com">SyncUp@support.com</a>.
          </v-card-text>
        </v-container>
      </v-card>
    </v-dialog>
...
export default {
  ...
  mounted() {
    if (this.pemail) this.email = this.pemail
  },
  watch: {
    dialog() {
